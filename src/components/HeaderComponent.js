...
import { Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Button,
    Modal, ModalBody, ModalHeader, FormGroup, Form, Input, Label} from 'reactstrap';
...
class Header extends Component{
    ...
    handleLogin(event){
        this.toggleModal();
        alert("Username: " + this.username.value + " Passowrd: " + this.password.value + 
                ...
                <div className="container">
                    <div className="row row-header">
                        <div className="col-12 col-sm-6">
                            ...
                            <p>We take inspiration from world's best cuisines, and create a unique fusion 
